...
const VacancyItem = () => {
  return (
    <div className="vacancy__item">
      <h2 className="item__name">Менеджер-дизайнер</h2>
      <div className="item__conditions">
        <span className="conditions__salary">з/п от 70000 rub.</span>
        <span className="conditions__time">Полный рабочий день</span>
      </div>
      ...
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className='location__img'>
        ...
        <span className="location__text">Новый Уренгой</span>
      </div>
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className='star'>
